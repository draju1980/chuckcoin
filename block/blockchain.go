...
const (
	...
	BLOCKCHAIN_PORT_RANGE_START       = 3000
	BLOCKCHAIN_PORT_RANGE_END         = 3003
...
// func to return previous hash
func (b *Block) PreviousHash() [32]byte {
	return b.previousHash
}

// func to return nonce
func (b *Block) Nonce() int {
	return b.nonce
}

// func to return tx pool
...
// func to return chain
func (bc Blockchain) Chain() []*Block {
	return bc.chain
}

// func to StartSyncNaighbor function
func (bc *Blockchain) Run() {
	bc.StartSyncNeighbors()
	bc.ResolveConflicts()
}

// func to set Blockchain
...
// function to sync neighbor nodes
...
// function to start syncneighbor
