...
// this func will look for host connection based on ip and port
...
// this func will find other node with port 3000 to 3002
...
// This is get own hostname and ip address
func GetHost() string {
